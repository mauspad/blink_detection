...
KNOWN ISSUES I'M WORKING ON: Errors out when it reaches the last frame of the video. Also writes to the csv on every loop instead of writing the whole list at the end, which slows down the program a lot.